...
export default function ChefProfile() {
  ...
  const fetchProfile = async () => {
    try {
      ...
      const response = await fetch(`${API_URL}/chef/profile`, {
        headers: {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      <h1 className="text-3xl font-bold mb-6">My Chef Profile</h1>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md p-6 space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">Cuisine Specialization</label>
          <input
            type="text"
